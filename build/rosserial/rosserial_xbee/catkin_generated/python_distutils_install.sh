...
echo_and_run cd "/home/pi/Documents/ros_tracker/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/home/pi/Documents/ros_tracker/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/pi/Documents/ros_tracker/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
