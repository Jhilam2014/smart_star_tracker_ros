...
echo_and_run cd "/home/pi/Documents/ros_tracker/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/home/pi/Documents/ros_tracker/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/pi/Documents/ros_tracker/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
