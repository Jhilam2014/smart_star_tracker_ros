...
echo_and_run cd "/home/pi/Documents/ros_tracker/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/home/pi/Documents/ros_tracker/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/pi/Documents/ros_tracker/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
